...
import vn.com.anhtuan.authservice.utils.OAuth2Utils;
...
public class OAuth2PasswordGrantAuthenticationConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        Authentication clientPricipal = SecurityContextHolder.getContext().getAuthentication();

        if(clientPricipal == null) {
