...
import vn.com.anhTuan.commons.security.UserDetailsImpl;
...
public class AuthorizationServerConfig {
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> tokenCustomizer() {
        return context -> {
            ...
            if(context.getPrincipal() instanceof UserDetailsImpl) {
    ...
    public DefaultSecurityFilterChain authorizationSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        auth2AuthorizationServerConfigurer.tokenEndpoint(tokenEndpoint -> {
            try {
                tokenEndpoint
